...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center container">
        ...
        >
          ...
          <span className="font-bold text-xl">
            Builder OS<span className="text-muted-foreground"> by Hevarto</span>
          </span>
        </Link>
      ...
      <hr
        className={cn(
          "absolute w-full bottom-0 border-t border-primary/20 transition-opacity duration-300 ease-in-out",
